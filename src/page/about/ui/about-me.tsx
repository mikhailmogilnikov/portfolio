  ...
  return (
    ...
    >
      <Text
        ...
        opacity={0.6}
      >
        Я начал свой путь в роли разработчика в 2022 году с конструкторов сайтов
        , желая изменить внешний вид встроенных блоков при помощи CSS. <br />
        <br />
        Сейчас я создаю многофункциональные приложения, используя передовые
        технологии в области веб-разработки. Начиная с дизайна и заканчивая
        выгрузкой в сеть.
      </Text>
